...
export default class PlacesSearchesModal extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return(
            <div className="modal" tabindex="-1" role="dialog" data-show="true" style={this.state.modalStyle}>
                <div className="modal-dialog" role="document" style={blackFont}>
                    <div className="modal-content">
                    <div className="modal-header text-center">
                        <button type="button" className="close" onClick={this.onCloseClicked} aria-label="Close">
                    ...
                    <div className="modal-footer">
                        ...
                        <button type="button" className="btn btn-secondary" onClick={this.onCloseClicked}>Anuluj</button>
                    </div>
                    </div>
                </div>
            </div>
